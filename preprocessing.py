...
def swt_reconstruct(coeffs, wavelet):
    x_hat = pywt.iswt(coeffs, wavelet)
    return x_hat
# =================================================================================================================================================
...
# =================================================================================================================================================
# =================================================================================================================================================
def main_denoise(padding, x, level, wavelet, k_factors_method, use_debugging, threshold_method, threshold_rule):
    #variables
    new_coeffs = []
    k = []
    threshold =[]
    ...
    elif threshold_rule == "keine ahnung hier mehr":####################################################################
        pass
    ...
    #recosntruct
    signal = swt_reconstruct(new_coeffs, wavelet)
    return signal
...
#testing
    ...
    plot_spec(data, sr)
    signal = main_denoise(padding="zero", x=data, level=7, wavelet='db4', k_factors_method=None, use_debugging=False, threshold_method="soft", threshold_rule="visushrink")
    plot_spec(signal, sr)
